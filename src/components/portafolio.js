        ...
        {Array.from({ length: 1 }).map((_, idx) => (
          <Col key={idx}>
            ...
            >
              ...
              <Card.Body>
                <Card.Title
                  className="text-center bold h2 bg-success img-thumbnail rounded-3"
                ...
                <Card.Text style={{ fontFamily: "Raleway,bold" }}>
                  ...
                  <p className="text-justify">
                    "El software School.info busca mejorar la eficiencia
                    operativa, académica y comunicativa de cualquier institución
                    y al mismo tiempo promover un entorno de aprendizaje
                    colaborativo y accesible. Este sistema facilita los procesos
                    y/o tareas administrativas tales como, inscripción de
                    estudiantes y docentes, control de asistencia, generación de
                    reportes académico y convivenciales. Permite la creación,
                    seguimiento y evaluación de planes de estudio y programas
                    académico, así mismo permite establecer canales de
                    comunicación entre docentes, estudiantes y personal
                    administrativo, facilita la interacción entre la institución
                    educativa y padres de familia acerca del desempeño académico
          ...
          <Col key={idx}>
            ...
            >
              ...
              <Card.Body>
                ...
                >
                  “Factores demográficos, socioeconómicos y académicos que
        ...
        {Array.from({ length: 1 }).map((_, idx) => (
          <Col key={idx}>
            ...
            >
              ...
              <Card.Body>
                <Card.Title
                  className="text-center bold h3 bg-success  img-thumbnail rounded-3"
                  style={{ fontFamily: "Raleway,bold" }}
                >
