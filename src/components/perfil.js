    ...
    return (
      ...
      >
        <div className="form-content">
          ...
          >
            <p>Soy egresada de Misión Tic 2022 y Licenciada en matemáticas y estadística, con experiencia en análisis de datos estadísticos, sistematización de información,
